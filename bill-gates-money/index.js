...
let counterDom1 = 2516;
let counterDom2 = 4542;
let counterDom3 = 5415;
let counterDom4 = 122254;
let counterDom5 = 9855;
let startBasket = 0;
let startBasket2 = 0;
let startBasket3 = 0;
let startBasket4 = 0;
...
domToplamPara.innerHTML =  Number.MAX_SAFE_INTEGER;
...
function increaseBasketOne() {
  ...
  domToplamPara.innerHTML = `${(sumMoney -= 2516)}TL`;
...
function increaseBasketTwo() {
  ...
  domToplamPara.innerHTML = `${(sumMoney -= 4542)} TL`;
  sumMoney <= 0 ? domToplamPara.innerHTML=`${sumMoney}`: domToplamPara.innerHTML=`${sumMoney} TL`;
  if(sumMoney <= 0 ){
...
function increaseBasketThree() {
  ...
  domToplamPara.innerHTML = `${(sumMoney -= 5415)} TL`;
  sumMoney <= 0 ? domToplamPara.innerHTML=`${sumMoney}`: domToplamPara.innerHTML=`${sumMoney} TL`;
  if(sumMoney <= 0 ){
...
function increaseBasketFour() {
  ...
  domToplamPara.innerHTML = `${(sumMoney -= 122254)} TL`;
  sumMoney <= 0 ? domToplamPara.innerHTML=`${sumMoney}`: domToplamPara.innerHTML=`${sumMoney} TL`;
  if(sumMoney <= 0 ){
...
function increaseBasketFive() {
  ...
  domToplamPara.innerHTML = `${(sumMoney -= 9855)} TL`;
  sumMoney <= 0 ? domToplamPara.innerHTML=`${sumMoney}`: domToplamPara.innerHTML=`${sumMoney} TL`;
  if(sumMoney <= 0 ){
